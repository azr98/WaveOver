...
export async function POST(req) {
  try {
    ...
    // Compose email
    const email_subject = `${data.user_firstname} ${data.user_lastname} wants to discuss '${data.argument_topic}' with you`;
    const email_body_html = `
      ...
      <body>
      <p>Just sign up or log in at <a href="dev.waveover.info">dev.waveover.info</a> and accept the discussion in 'Pending'. Then a 3 day timer will start.</p>
      ...
      <p>Both of you will receive a reminder 2 days, 1 day, 12 hours and 4 hours before the 3 day deadline.</p>
