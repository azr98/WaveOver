    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-start py-12 px-4">
      ...
      <div className="bg-white rounded shadow p-6 max-w-2xl w-full mx-4 sm:mx-8" style={{ marginLeft: 16, marginRight: 16 }}>
        ...
        <ul className="list-disc pl-6 mb-6 space-y-2">
          ...
          <li>No back-and-forth replies = no "chain reactions"</li>
        ...
        <ul className="list-disc pl-6 mb-3 space-y-1">
          <li><span className="text-green-700">✔️ "I felt hurt when you ignored my call."</span></li>
          <li><span className="text-red-700">❌ "I was hurt by the ignoring of my call."</span></li>
        </ul>
        ...
        <p className="mb-2">Are you aiming to share feelings, ask a question, or solve a problem? Start with that intention.</p>
        <h3 className="font-semibold mt-4 mb-1">2. Consider your partner's lens</h3>
        <p className="mb-2">Think: What do they already know? How do they prefer to communicate?</p>
        <h3 className="font-semibold mt-4 mb-1">3. Pause when you're emotional</h3>
        <p className="mb-6">Strong emotions = strong reactions. Walk, breathe, reflect—then write.</p>
        <hr className="my-6" />
