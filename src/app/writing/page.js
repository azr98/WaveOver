  ...
  return (
    <div className="help-container">
      ...
      <div className="help-content">
        ...
        <p className="mb-6 text-center">WaveOver gives you a powerful way to communicate with clarity, calm, and connection—through asynchronous writing.<br />Here's how to make the most of it.</p>
        <hr className="my-6" />
        <h2 className="text-xl font-semibold mb-2"> Why WaveOver works: The Power of the Pause</h2>
        ...
        <ul className="list-disc pl-6 mb-3 space-y-1">
          ...
          <li>Use formatting to break up big blocks.</li>
        </ul>
        ...
        <ul className="list-disc pl-6 mb-3 space-y-1">
          <li><span className="text-green-700">✔️ "I felt ___ when that happened."</span></li>
        ...
        <p className="mb-6">Do this after you have exhausted all of the emotion and forget about it when you are away. Then re-examine and re-considerwhat you said with a clear head</p>
        <h3 className="font-semibold mt-4 mb-1">4. Read it out loud before you send</h3>
        ...
        <p className="mb-4">Writing slows us down. It makes us reflect.<br />It transforms reactive talk into intentional and thoughtful connection.<br />Use this app to say what matters—with clarity, compassion, and calm.</p>
